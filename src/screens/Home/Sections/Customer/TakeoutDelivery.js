      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, padding: 12, backgroundColor: '#fff', borderTopWidth: 1, borderColor: '#eee' }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-start', flexWrap: 'wrap', marginBottom: 12 }}>
            ...
            <TouchableOpacity onPress={openCustomerSelector} style={{ backgroundColor: customer ? '#dcfce7' : '#f3f4f6', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, marginRight: 8, marginBottom: 8, borderWidth: customer ? 1 : 0, borderColor: '#22c55e' }}>
              <Text style={{ fontWeight: '800', color: customer ? '#166534' : '#111' }}>{customer ? customer.name : 'Customer'}</Text>
            </TouchableOpacity>
            {selectedLine ? (
              <TouchableOpacity onPress={() => setLineDiscountModalVisible(true)} style={{ backgroundColor: '#fef3c7', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, borderWidth: 1, borderColor: '#f59e0b', marginRight: 8, marginBottom: 8 }}>
                <Text style={{ fontWeight: '800', color: '#92400e' }}>Add Discount</Text>
              </TouchableOpacity>
            ) : null}
            <TouchableOpacity 
